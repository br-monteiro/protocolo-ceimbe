...
class OmModel extends CRUD
{
    ...
    public function remover($id)
    {
        ...
        if (parent::editar($dados, $id)) {
            header('Location: '.APPDIR.'om/visualizar/');
        }
    }
    ...
    {
        $value = v::string()->notEmpty()->length(1, 6)->validate($this->getInitials());
        if (!$value) {
            msg::showMsg('O campo Indicativo Naval deve ser preenchido corretamente.'
